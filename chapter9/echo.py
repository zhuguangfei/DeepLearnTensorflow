...
def plot(loss_list,predictions_series,batchX,batchY):
    ...
    for batch_series_idx in range(batch_size):
        ...
        left_offset2=range(echo_step,truncated_backprop_length)
        label1='past values'
...
labesls_series=tf.unstack(batchY_placeholder,axis=1)

current_state=init_state
predictions_series=[]
losses=[]
for current_input,labels in zip(inputs_series,labesls_series):
